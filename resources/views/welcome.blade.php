                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="table-pricing paket-gila">
                                ...
                                <div class="item-benefit-pricing mb-4">
                                    <img src="{{asset('ic_check.svg')}}" alt="">
                                    <p>
                                        Pro Techstack Kit
                                    </p>
                                    <div class="clear"></div>
                                ...
                                <p>
                                    <a href="{{route('checkout.create', 'super-premium')}}" class="btn btn-master btn-primary w-100 mt-3">
                                        Take This Plan
                                    </a>
                                </p>
                            </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="table-pricing paket-biasa">
                                ...
                                <p>
                                    <a href="{{route('checkout.create', 'mini-premium')}}" class="btn btn-master btn-secondary w-100 mt-3">
